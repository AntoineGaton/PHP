...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // filter_input() is used for security and validation
        // INPUT_POST - checks POST data
        // 'user_name' - the name attribute from our form input
        // FILTER_SANITIZE_STRING - removes dangerous characters/HTML tags
        $user_name = filter_input(INPUT_POST, 'user_name', FILTER_SANITIZE_STRING);

        // Similar to above, but validates that age is a proper integer
        // If age isn't a valid integer, $user_age will be false
        // If age field was empty, $user_age will be null
        ...
        // to their HTML entities (like < becomes &lt;)
